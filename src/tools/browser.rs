...
fn prop(ty: PropertyType, d: &str) -> ToolInputProperty {
    ToolInputProperty { property_type: ty, description: Some(d.into()), enum_values: None, minimum: None, maximum: None, min_length: None, max_length: None, items: None, properties: None, required: None, additional_properties: None }
}
