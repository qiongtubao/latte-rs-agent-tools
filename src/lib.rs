...
pub mod prelude {
    ...
    pub use crate::tools::{
        builtin_tool_packages, AstToolsPackage, BrowserToolsPackage, EditToolsPackage,
        EvalToolsPackage, file_find_tool, file_read_tool, file_search_tool, FileToolsPackage,
